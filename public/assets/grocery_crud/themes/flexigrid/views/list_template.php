...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
			...
			<div class="fbutton">
				<div>
					<span class="add <?= (in_array("['Chandni Banquet Hall (125 Chrysler Dr)'=>'Add/Edit']", $permission) && $id ==1) || (in_array("['Chandni Gateway (5 Gateway Blvd)'=>'Add/Edit']", $permission) && $id ==2) || (in_array("['Chandni Convention Centre (5 Gateway Blvd)'=>'Add/Edit']", $permission) && $id ==3) || (in_array("['Caledon Country Club'=>'Add/Edit']", $permission) && $id ==4) || (in_array("['Chandni Victoria (2935 Drew Rd)'=>'Add/Edit']", $permission) && $id ==5) || (in_array("['Event Types Portion'=>'Add/Edit']", $permission) && $text =='eventTypes') || (in_array("['Venues/Halls Portion'=>'Add/Edit']", $permission) && $text =='venues') || (in_array("['Venues/Halls Portion'=>'Add/Edit']", $permission) && $text =='venueHalls') || (in_array("['Buffet/Dishes Portion'=>'Add/Edit']", $permission) && $text =='buffetItems') || (in_array("['Buffet/Dishes Portion'=>'Add/Edit']", $permission) && $text =='menuItems') ? '' : 'd-none' ?>
"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
				</div>
			</div>
            </a>
