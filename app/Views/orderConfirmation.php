        ...
        <table width=100%>
            ...
            <tr>
                ...
                <?php 
                    ...
                    echo date('Y-m-d', strtotime($_SESSION["EVENTS"]["STEP-1"]["event_datetime"])) ." (". $time.")";
                    ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding-left: 10px">
                    <?=$_SESSION["EVENTS"]["STEP-1"]["need_a_hall_rental"]=='Yes' ? 'No' : 'Yes'?>
                </td>
            </tr>                      
            <tr>
                <td>
                    ...
                    <tr>
                        ...
                        <table>
                            ...
                            <td style="vertical-align:top">
                                <strong><?=$key?></strong>
                                <?php if($key=='APPETIZER' || $key=='MAIN COURSE'){ ?>
                                (<br>
                                Start Time: <?=$key=='APPETIZER' ? date('h:i A', strtotime($_SESSION["APPETIZER"]["start_time"]))  : date('h:i A', strtotime($_SESSION["MAINCOURSE"]["start_time"])) ?><br>
                                End Time:   <?=$key=='APPETIZER' ? date('h:i A', strtotime($_SESSION["APPETIZER"]["end_time"]))  : date('h:i A', strtotime($_SESSION["MAINCOURSE"]["end_time"])) ?>
                                <br>)
                                <?php } ?>
                            </td>
            ...
            <div class="col-3">
            <button type="submit" class="btn btn-primary mr-2" style="height: 40px;width: max-content;"><?php 
            ...
            <div class="col-3"><button type="button" onclick="document.location='/events/new'" class="btn btn-dark" style="height: 40px;width: max-content; margin-left: 40px;">MODIFY ORDER</button></div>
            <div class="col-3"><button type="button" onclick="document.location='/events/reset'" class="btn btn-dark" style="height: 40px;width: max-content;margin-left: 90px;">RESET SELECTION</button></div>
            <div class="col-3"><button type="button" class="btn btn-primary" style="height: 40px;width: 145px;margin-left: 160px;" onclick="printDiv()">Print</button></div>
            </div>
