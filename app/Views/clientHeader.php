  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="/home"><img src="<?php echo isset($_SESSION["client_id"]) || isset($_SESSION["user_id"]) ? $_SESSION["logo"] : 'https://chandani.dinxstudio.com/assets/images/User-Administrator-Blue-icon.png' ?>" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="/home"><img src="<?php echo isset($_SESSION["client_id"]) || isset($_SESSION["user_id"]) ? $_SESSION["logo"] : 'https://chandani.dinxstudio.com/assets/images/User-Administrator-Blue-icon.png'?>" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?=isset($_SESSION["avatar"]) ? $_SESSION["avatar"] : 'https://chandani.dinxstudio.com/assets/images/default.jpeg' ?>" alt="profile"/>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              <a href="/home/setting/client_setting" class="dropdown-item">
