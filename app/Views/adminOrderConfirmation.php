    ...
    <div class="card-body" id="myDiv">
        ...
        <table width=100%>
            ...
            <div class="row not-print">
                <div class="col-3">
                <button type="submit" class="btn btn-primary" style="height: 40px;width: max-content;"><?php 
            ...
            ?></button>   
                ...
                <div class="col-3"> 
                <button type="button" onclick="document.location='/AdminEvents/new'" class="btn btn-dark" style="height: 40px;width: max-content;margin-left: 40px;">MODIFY ORDER</button> 
                </div>
                <div class="col-3">
                <button type="button" onclick="document.location='/AdminEvents/reset'" class="btn btn-dark" style="height: 40px;width: max-content;margin-left: 90px;">RESET SELECTION</button>
                </div>

                <div class="col-3">
                <button type="button" class="btn btn-primary" style="height: 40px;width: 150px;margin-left: 160px;" onclick="printDiv()">Print</button>
                </div>
