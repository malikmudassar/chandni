...
$redirect_uri = 'https://chandani.dinxstudio.com/events/deletecalendar';
...
if (isset($_GET['code'])) {
    ...
    try {
        ...
        if ($is_deleted) {
           ...
           header("Location: https://chandani.dinxstudio.com/events/delete/".$_SESSION["EVENTS"]["delete_event_id"]."");
        } else {
