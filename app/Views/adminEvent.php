                ...
                <div class="card-body">
                  ...
                  <form action="/AdminEvents/new" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        ?>
                          <option <?php if (isset($tblcompany_client_id) && $client->id==$tblcompany_client_id) echo "selected"; ?> value="<?=$client->id?>"><?php echo $client->first_name.' '.$client->last_name.'('.$client->email.')' ?></option>
                        <?php
                          }
                        ?>
                        </select>
                  ...
                  <p class="card-description">Event Details</p>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-holder" style="width:100%;display:none;" id="how_many_security_gaurds" >
